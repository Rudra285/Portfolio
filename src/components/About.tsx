...
const About = () => {
  ...
  return (
    <section
      ...
      style={{ padding: '4rem 0', width: '100%', backgroundColor: '#001317' }}
    >
      <div className="container">
        <h2 className="mb-5 text-center" style={{ fontWeight: 'bold' }}>My Background</h2>
          ...
          <div className="col-md-6">
            ...
            <div className="d-flex align-items-center gap-4 p-3 mt-4 rounded" style={{ backgroundColor: '#CC0000', color: 'white' }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: '0.9rem' }}>MS in Computer Science - Software Development</p>
              </div>
            </div>
          </div>
